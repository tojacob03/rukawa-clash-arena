            ...
            return (
              <div key={`${id}-${index}`} className="relative group">
                <div className="relative overflow-hidden rounded-lg bg-card border shadow-sm transition-transform hover:scale-105 aspect-[3/4]">
                  ...
                  <div className="absolute top-0 left-0 bg-primary text-primary-foreground text-[8px] sm:text-[10px] font-bold rounded-full w-4 h-4 sm:w-4 sm:h-4 flex items-center justify-center">
                    {base ? elixir : '?'}
                  </div>
