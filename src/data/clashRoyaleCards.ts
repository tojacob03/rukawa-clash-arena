...
export const CLASH_ROYALE_CARDS: ClashRoyaleCard[] = [
  ...
  // Ensure Goblin Machine (26000096) is recognized locally; image and elixir resolved via remote fallback
  { id: 26000096, name: "Goblin Machine", imageUrl: "/placeholder.svg", elixir: 0, type: "troop" },
