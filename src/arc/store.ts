...
export type Route = "heute" | "log" | "karte" | "meer" | "codex" | "held" | "freunde" | "profil" | "konto" | "plan" | "matte" | "gym" | "einladung";
const ROUTES: Route[] = ["heute", "log", "karte", "meer", "codex", "held", "freunde", "profil", "konto", "plan", "matte", "gym", "einladung"];
